    ...
    public partial class init : Migration
    {
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrderHandlers", x => x.OrderId);
                    table.ForeignKey(
                        name: "FK_OrderHandlers_Handlers_HandlerId",
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<int>(type: "int", nullable: false)
                        .Annotation("SqlServer:Identity", "1, 1"),
                    ProductNumber = table.Column<string>(type: "char(50)", nullable: false),
                    ...
                    ProductPrice = table.Column<string>(type: "varchar(20)", nullable: false),
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrderHandlers_HandlerId",
                table: "OrderHandlers",
                column: "HandlerId");

            migrationBuilder.CreateIndex(
                name: "IX_OrderHandlers_OrderId1",
                table: "OrderHandlers",
                column: "OrderId1");
            ...
            migrationBuilder.AddForeignKey(
                name: "FK_OrderHandlers_Orders_OrderId1",
                table: "OrderHandlers",
                column: "OrderId1",
                principalTable: "Orders",
                principalColumn: "Id",
